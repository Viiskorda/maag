        ...
        public function __construct()
	{
        ...
        public function view($page = 'home')
        {
                ...
                foreach ( $data['sportPlacesToChoose'] as $each) {
                        ...
                        //         var_dump( $each->id);
                        $this->session->set_flashdata('user_registered', 'Kahjuks teil puuduvad õigused selle saali redigeerimiseks. Saali seisu vaatamiseks peate välja logima või avama teise veebilehitsejaga');
                        redirect('');
                        };
                };
